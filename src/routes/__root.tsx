  ...
  head: () => ({
    meta: [
      ...
      { title: "Taara — One Platform For Every AI Tool" },
      {
        name: "description",
        content:
          "Chat, create, generate, compare and discover the world’s most powerful AI tools. 50+ tools, multi-model chat, image & video generation in one futuristic platform.",
      },
      ...
      { property: "og:title", content: "Taara — One Platform For Every AI Tool" },
      {
        ...
        content:
          "Chat with GPT, Gemini, Claude and more. Generate images and videos. Discover 50+ AI tools in one premium dashboard.",
      },
